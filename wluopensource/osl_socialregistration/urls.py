"""
Open Source at Laurier version of urlconf

Doing this to point setup at form requiring email address for registration
"""
from django.conf import settings
from django.conf.urls.defaults import *

from osl_socialregistration.forms import OslUserForm

urlpatterns = patterns('',
    url('^setup/$', 'socialregistration.views.setup', 
        {'form_class': OslUserForm}, name='socialregistration_setup'),
